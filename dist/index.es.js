import React__default, { createElement, useState as useState$1, useEffect as useEffect$1, cloneElement, Fragment as Fragment$1 } from 'react';
...
var MUISelectField = function (props) {
    ...
    if (selectProps.native) {
        if (menuOptions)
            optionsList = map(menuOptions, function (item, index) {
    ...
    return (createElement(FormControl, __assign({ error: !!fieldError }, formControlProps),
        ...
        createElement(FormGroup, __assign({}, checkGroupProps), (!isEmpty(menuOptions)) ?
            (map(menuOptions, function (item, index) {
                ...
                return (createElement(FormControlLabel, __assign({ key: fieldConfig.id + "_check_" + index, label: name || '' }, formControlLabelProps, { control: control !== null && control !== void 0 ? control : createElement(Checkbox, __assign({ checked: (indexOf(value, option) > -1), onBlur: formikProps.handleBlur, onChange: formikProps.handleChange, value: item.value }, __assign(__assign({}, checkboxProps), { id: fieldConfig.id + "_check_" + index }))) }, rest)));
            })) : (createElement(FormControlLabel, __assign({ control: createElement(Checkbox, __assign({ checked: (value || false), onBlur: formikProps.handleBlur, onChange: formikProps.handleChange }, checkboxProps)), label: isLabelHtmlString ? createElement("div", { dangerouslySetInnerHTML: { __html: label } }) : label }, formControlLabelProps)))),
...
export { BuildFormRow, COUNTRY_LIST, MLFormAction, MLFormBuilder, MLFormContent, MUICheckBox, MUIFieldArray, MUIFileInput, MUIPhoneField, MUIRadio, MUIReadOnly, MUISelectField, MUISwitch, MUITextField, ReactForm, attachField, getComponentConfig, getFieldError, getMenuOptions, processFilesWithCallback, setDefaultProps, setValue };
